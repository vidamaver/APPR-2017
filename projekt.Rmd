...
V svojem projektu pri predmetu Analiza podatkov s programom R analiziram količine zračnih emisij v evropskih državah.

Prikazala bom dve tabeli in sicer:

V prvi tabeli je po posameznih letih prikazana količina tipa določenega izpusta po državah (v tonah) v posamezni veji industrije. Merjeni tipi izpusta so ogljikov dioksid, didušikov oksid, dušikov monoksid in metan. Za vsako državo je prikazana tudi količina določenega tipa izpusta v vseh panogah industrije skupaj.

V drugi tabeli pa je prikaz držav in njihovih površin, merjenih v kvadratnih kilometrih.
...
Poglejmo si začetek prve uvožene razpredelnice.

```{r razpredelnice}
kable(head(Zracne_emisije_po_drzavah))
head(Zracne_emisije_po_drzavah)
```
